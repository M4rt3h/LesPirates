...
//Utiliser le prototype pour faire diagramme séquence -> lorsque il y a un truc en dur (style les cartes ou les noms de joueurs)
	...
	public int debuterTour(String nomJoueur, String[] main) {
		...
		while (!valide) {
			...
			if (scanner.hasNextInt()) {
				...
				// Vérifier si l'entier est entre 1 et 5
				if (choix >= 1 && choix <= 5) {
